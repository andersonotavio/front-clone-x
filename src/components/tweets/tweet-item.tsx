...
import { faRetweet, faHeart as faHearFilled } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="flex gap-2 p-6 border-b-2 border-gray-900">
      ...
      <div className="flex-1">
        ...
        <div className="flex mt-6 text-gray-500">
          ...
          <div className="flex-1">
              <div className={`inline-flex items-center gap-2 cursor-pointer ${liked ? 'text-red-500' : ''}`} onClick={handleLikeButton}>
                <FontAwesomeIcon icon={liked ? faHearFilled : faHeart} className="size-6" />
